...
public final class Form_QLSP extends javax.swing.JPanel {
    ...
    public Form_QLSP() {
        ...
        productId.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                SanPham sanPham = sanPhamService.getByMaSP(productId.getText());
                if (sanPham.getId() != null) {
                    ...
                    productName.setText(sanPham.getTenSp());
                    productDescription.setText(sanPham.getMoTa());
    ...
    private void mouseClickSanPham(int row) {
        ...
        ThuocTinh thuocHieu = thuocTinhService.getThuocTinhById(sanPham.getIdThuongHieu(), "ThuongHieu");
        ThuocTinh thanhPhan = thuocTinhService.getThuocTinhById(sanPham.getIdThanhPhan(), "ThanhPhan");
        productId.setText(sanPham.getMaSp());
        productName.setText(sanPham.getTenSp());
        productDescription.setText(sanPham.getMoTa());
        jComboBox1.setSelectedItem(thuocHieu.getValue());
        jComboBox2.setSelectedItem(thanhPhan.getValue());
    ...
    private void mouseClickSPCT(String idspct) {
        ...
        Tab2ProductId.setText(spct.getMa());
        Tab2ProductPrice.setText(spct.getGia().toString());
        Tab2ProductQuantity.setText(spct.getSoLuong().toString());
        if (spct.getAnh() != null) {
    ...
    SanPhamChiTiet readDataSPCT() {
        ...
        return SanPhamChiTiet.builder()
                .ma(Tab2ProductId.getText())
                .idSanPham(sp.getId())
                .idKhoiLuong(khoiLuong.getId())
                .idDoRang(doRang.getId())
                .idHuongVi(huongVi.getId())
                .anh(jLabel16.getToolTipText())
                .soLuong(Integer.valueOf(Tab2ProductQuantity.getText()))
                .gia(Integer.valueOf(Tab2ProductPrice.getText()))
                .build();
    }
    ...
    private String validateData() {
        String maSp = productId.getText().trim();
        String tenSp = productName.getText().trim();
        String moTa = productDescription.getText().trim();
        if (maSp.isEmpty()) {
    ...
    private void initComponents() {
        ...
        Tab2ProductId = new javax.swing.JTextField();
        jLabel17 = new javax.swing.JLabel();
        Tab2ProductPrice = new javax.swing.JTextField();
        jLabel18 = new javax.swing.JLabel();
        Tab2ProductQuantity = new javax.swing.JTextField();
        ...
        Tab3AttributeName = new javax.swing.JTextField();
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(productId, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(productDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(productDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(20, 20, 20))
        );
        ...
        Tab2ProductId.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Tab2ProductId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tab2ProductIdActionPerformed(evt);
            }
        });
        ...
        Tab2ProductPrice.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Tab2ProductPrice.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tab2ProductPriceActionPerformed(evt);
            }
        });
        ...
        Tab2ProductQuantity.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        Tab2ProductQuantity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Tab2ProductQuantityActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(Tab2ProductPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel17, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(Tab2ProductQuantity, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    .addComponent(Tab2ProductId, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(90, 90, 90)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(Tab2ProductId, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(Tab2ProductPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(Tab2ProductQuantity, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        Tab3AttributeName.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                        ...
                        .addGroup(jPanel3Layout.createSequentialGroup()
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    ...
                                    .addGap(30, 30, 30)
                                    .addComponent(Tab3AttributeName, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGap(126, 126, 126)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(Tab3AttributeName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jRadioButton1)
                        .addComponent(jRadioButton2)
                        .addComponent(jRadioButton3)))
                .addGap(38, 38, 38)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (!productId.getText().isBlank()) {
            ...
            jTextField5.setText(productId.getText());
            jTextField6.setText(productName.getText());
            jTextField5.setEnabled(false);
            jTextField6.setEnabled(false);
            SanPham sp = sanPhamService.getByMaSP(productId.getText());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (Tab3AttributeName.getText().trim().isEmpty()) {
        ...
        ThuocTinh thuocTinh = new ThuocTinh(null, Tab3AttributeName.getText());
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        boolean checkValue = thuocTinhService.exitsByTen(Tab3AttributeName.getText(), key);
        if (checkValue) {
        ...
        thuocTinh.setId(id);
        thuocTinh.setValue(Tab3AttributeName.getText());
        ...
        loadData();
        Tab3AttributeName.setText("");
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        int row = jTable2.getSelectedRow();
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "Vui lòng chọn thuộc tính cần xoá");
            return;
        }
        DefaultTableModel tm = (DefaultTableModel) jTable2.getModel();
        String key = "DoRang";
...
//            return;
//        }
        if (ValidationUtils.isEmpty(productId.getText())) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập mã sản phẩm!");
        } else {
            if (ValidationUtils.isEmpty(productName.getText())) {
                ...
                JOptionPane.showMessageDialog(this, "Vui lòng nhập thành phần!");
            }
            else{
                try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (ValidationUtils.isEmpty(productId.getText())) {
            ...
            if (MsgHelper.confirm(this, "Bạn có muốn sửa không?") == true) {
                ...
                sanPhamService.updateSanPham(sanPham, productId.getText());
                loadDataSanPham();
    ...
    private void Tab2ProductIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tab2ProductIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tab2ProductIdActionPerformed

    private void Tab2ProductPriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tab2ProductPriceActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tab2ProductPriceActionPerformed

    private void Tab2ProductQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Tab2ProductQuantityActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tab2ProductQuantityActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        if (ValidationUtils.isEmpty(Tab2ProductId.getText())) {
            MsgHelper.alert(this, "Vui lòng thêm mã chi tiết sản phẩm");
        } else {
            if (!ValidationUtils.isNumber(Tab2ProductPrice.getText())) {
                MsgHelper.alert(this, "Giá sản phẩm không hợp lệ!");
            } else {
                if (!ValidationUtils.isNumber(Tab2ProductQuantity.getText())) {
                    MsgHelper.alert(this, "Số lượng sản phẩm khum hợp lệ!");
                } else {
                    try {
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        jTextField5.setText("");
        jTextField6.setText("");
        Tab2ProductId.setText("");
        Tab2ProductPrice.setText("");
        Tab2ProductQuantity.setText("");
    ...
    private javax.swing.JTextField Tab2ProductId;
    private javax.swing.JTextField Tab2ProductPrice;
    private javax.swing.JTextField Tab2ProductQuantity;
    private javax.swing.JTextField Tab3AttributeName;
